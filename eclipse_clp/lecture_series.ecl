/*
  ...
  Lecture series puzzle (Dell Logic Puzzles) in ECLiPSe.
...
go :-
        ...
        % 4. A man gave the lecture on modern art.
        (
            ModernArt #= Charles or ModernArt #= Duane or
            ModernArt #= Eddie
        ),
        ...
        % print solution
        calc_size([FirstNameS,LastNameS,LecturesS],Size,2),
        print_all(Days,DaysS,Size),
        print_all(FirstName,FirstNameS,Size),
        print_all(LastName,LastNameS,Size),
        print_all(Lectures,LecturesS,Size),
        fail.
