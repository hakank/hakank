/*
  ...
  General store problem in ECLiPSe.
...
store2(LD) :-
        ...
        search(LD, 0, first_fail, indomain, complete,[]),
        search(Carries, 0, first_fail, indomain, complete,[]).
...
store3(LD) :-
        ...
        search(LD, 0, first_fail, indomain, complete, []),
        search(CarriesLow, 0, first_fail, indomain, complete, []),
        search(CarriesHigh, 0, first_fail, indomain, complete, []).
