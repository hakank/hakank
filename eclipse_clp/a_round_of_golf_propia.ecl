/*
  ...
  * Comet   : http://www.hakank.org/comet/a_round_of_golf.co
  ...
  actually an ECLiPSe/Prolog program, but I have used a CLP approach
  here. 

  Compared to my other ECLiPSe model of this problem
  (  http://www.hakank.org/eclipse/a_round_of_golf.ecl )
  this model use arrays (works when Propia is loaded).
