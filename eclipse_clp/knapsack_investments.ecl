/*
  ...
  Knapsack (investment) problem in ECLiPSe.
  ...
  * SICStus: http://www.hakank.org/sicstus/knapsack_investments.pl
...
go :-
        ...
        TotalPersons #= Personell*X,
        TotalBudget #= Budgets*X,
        sum(X)#=TotalProjects,
        ...
        minimize(search(X,0,occurrence,indomain_min, complete,[backtrack(Backtracks)]),TotalValuesNeg),
        % output
        write(X),nl,
        ...
        write(total_values:TotalValues),nl,
