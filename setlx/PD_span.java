...
// span(string, pattern)     : SNOBOL string scanning function:  removes and returns all initial characters in string that are in pattern. 

public class PD_span extends PreDefinedFunction {
  public final static PreDefinedFunction DEFINITION = new PD_span();
