...
(require (only-in "utils_hakank.rkt"
                  time-function list-product chunks-of
                  ))

(define *1000-digit-number*
  '(7 3 1 6 7 1 7 6 5 3 1 3 3 0 6 2 4 9 1 9 2 2 5 1 1 9 6 7 4 4 2 6 5 7 4 7 4 2 3 5 5 3 4 9 1 9 4 9 3 4 9 6 9 8 3 
...
(define (euler8a)
  (apply max (map list-product (chunks-of *1000-digit-number* 5)))
  )

;;; cpu time: 2 real time: 2 gc time: 0
(define (euler8b)
  (length *1000-digit-number*)
  (apply max (for/list ([i (range 0 (- 1000 4))])
    (list-product (map (lambda (v) (list-ref *1000-digit-number* v)) (range i (+ i 5))))
    ))
  )

(define (run)
  (time-function euler8a)
  ;;; (time-function euler8b)
  )
