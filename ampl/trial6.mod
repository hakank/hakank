...
s.t.  lcb1: x[1,1]-x[2,1]-2*d[1] <= -1 ;
s.t.  lcb2: x[1,1]-x[2,1]-d[1] >= -1;

s.t.  lcb3: x[1,1]-x[2,1]+2*d[2] >= 1;
s.t.  lcb4: x[1,1]-x[2,1]+2*d[2] <= 2;

s.t.  lcb5: d[1]+d[2]-t[1] <= 1;
s.t.  lcb6: d[1]+d[2]-2*t[1] >= 0;
