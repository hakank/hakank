...
p8 :: [Int] 
p8 = [7,3,1,6,7,1,7,6,5,3,1,3,3,0,6,2,4,9,1,9,2,2,5,1,1,9,6,7,4,4,2,6,5,7,4,7,4,2,3,5,5,3,4,9,1,9,4,9,3,4,9,6,9,8,3,
...
-- This is slow
euler8a :: Int
euler8a = maximum [ product [p8 !! (i+j) | i <- [0..4]] | j <- [1..(1000-5)]]

-- much faster than euler8a
euler8b :: Int
euler8b = maximum $ map (\i -> product $ take 5 $ drop i p8) [0..1000-4]

-- much faster than euler8b
euler8c' :: [Int] -> [Int]
euler8c' [] = [] -- This generates some [0]'s but it's faster than using guards to check lengths etc
-- It's slower to use alias, i.e. a@(x:xs) = .(.. take 5 a)
euler8c' (x:xs) = (product $ take 5 (x:xs)) : euler8c' xs

euler8c :: Int
euler8c = maximum $ euler8c' p8

-- Same idea as euler8c but using the general version of running product (defined in HakankUtils.curry)
euler8d :: Int
euler8d = maximum $ runningProd 5 p8

main :: IO ()
main = do
         -- PAKCS: Execution time: 8934 msec. / elapsed: 10117 msec. 
         -- KICS2: 1.69s+1.65s+ 0.13s
         -- Curry2Go: Compilation time: 7.42s / elapsed: 0:04.97 Execution time: 59.31s / elapsed: 0:18.37
         -- print euler8a
         
         -- PAKCS: Execution time: 918 msec. / elapsed: 1039 msec. 
         -- KICS2: 4.06s+1.67s+0.03s
         -- Curry2Go: Compilation time: 2.29s / elapsed: 0:01.70 Execution time: 3.88s / elapsed: 0:01.87
         -- print euler8b
         
         -- PAKCS: Execution time: 28 msec. / elapsed: 36 msec. 
         -- KICS2: 4.06s+1.68s+0.00s
         -- Curry2Go: Compilation time: 2.30s / elapsed: 0:01.70 Execution time: 0.11s / elapsed: 0:00.09
         print euler8c
         
         -- PAKCS: Execution time: 31 msec. / elapsed: 31 msec. 
         -- KICS2: 4.15s+1.70s+0.00s
         -- Curry2Go: Compilation time: 2.32s / elapsed: 0:01.71 Execution time: 0.10s / elapsed: 0:00.09
         -- print euler8d
