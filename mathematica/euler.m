...
(* 8.4s
   Not surprisingly, the calculation of the lengths takes most of the time: 8.3s
   The MaximalBy take about 0.15s
 *)
euler14[] := MaximalBy[{#, collatzLength[#]} & /@ Range[10^6], #[[2]]&];
euler14[]//AbsoluteTiming//Print
...
euler15[]//AbsoluteTiming//Print


Print["Euler problem 16"]

euler16[] := Total@IntegerDigits[2^1000]
euler16[]//AbsoluteTiming//Print
...
euler19[]//AbsoluteTiming//Print


Print["Euler problem 20"]

euler20[] := Total@IntegerDigits[100!]
euler20[]//AbsoluteTiming//Print


Print["Euler problem 21"]
...
euler22[]//AbsoluteTiming//Print


Print["Euler problem 23"]
(* slow: 13.4s *)
euler23[] := Block[{limit=20161,arr=Table[1,20161],abundant,abLen,i,j,abi,abj,pos},
             ...
             (* Table[If[a<=b && a+b <= limit,arr[[a+b]] = 0,Null], {a,abundant},{b,abundant}]; *)
             (* Do[If[a<=b && a+b <= limit,arr[[a+b]] = 0,Null], {a,abundant},{b,abundant}]; *)
             For[i = 1, i <= abLen, i++,
                abi=abundant[[i]];
                For[j = i, j <= abLen, j++,
                  abj=abundant[[j]];
             ...
             (*
             rangeAbLen = Range[abLen];
             pos = Outer[If[abundant[[#1]]<=abundant[[#2]] && abundant[[#1]]+abundant[[#2]] <= abLen,#1+#2]&,rangeAbLen,rangeAbLen]//Flatten;
             Print[pos];
             Total[pos] 
             *)
             ];
euler23[]//AbsoluteTiming//Print


Print["Euler problem 24"]

euler24[] := FromDigits[Permutations[Range[0,9]][[10^6]]]
euler24[]//AbsoluteTiming//Print
...
euler26[] := Block[{m,l},
          ...
          l[[Position[l, m] // Flatten]]
          ];
euler26[]//AbsoluteTiming//Print


Print["Euler problem 27"]
(* 23.2s, it's faster without caching the primes *)
...
euler30[]//AbsoluteTiming//Print

(* shorter and faster: 0.68s *)
euler30b[] := Total@Select[Range[10, 6 9^5], Total[IntegerDigits[#]^5] == # &]
euler30b[]//AbsoluteTiming//Print
...
euler31[]//AbsoluteTiming//Print

(* Solve the Diophantine equation *)
euler31b[] := FrobeniusSolve[{200,100,50,20,10,5,2,1},200]//Length
euler31b[]//AbsoluteTiming//Print

Print["Euler problem 32 TBW"]

Print["Euler problem 33 TBW"]

Print["Euler problem 34"]

euler34[] := Total@Select[Range[10, 100000], Total@Map[#! &, IntegerDigits[#]] == # &]
euler34[]//AbsoluteTiming//Print

(* shorter and slightly faster *)
euler34b[] := Total@Select[Range[10, 100000], Total[IntegerDigits[#]!] == # &]
euler34b[]//AbsoluteTiming//Print


Print["Euler problem 35 TBW"]

Print["Euler problem 36"]

euler36[] := Total@Select[Range[999999], palindromicQ[#] && palindromicQ[#, 2] &]
euler36[]//AbsoluteTiming//Print

Print["Euler problem 37 TBW"]
Print["Euler problem 38 TBW"]
Print["Euler problem 39 TBW"]
Print["Euler problem 40 TBW"]
Print["Euler problem 41 TBW"]
Print["Euler problem 42 TBW"]
Print["Euler problem 43 TBW"]
Print["Euler problem 44 TBW"]
Print["Euler problem 45 TBW"]
Print["Euler problem 46 TBW"]
Print["Euler problem 47 TBW"]

Print["Euler problem 48"]

euler48[] := IntegerDigits[Total@Map[#^# &, Range[1000]]][[-10 ;; -1]];
euler48[]//AbsoluteTiming//Print

Print["Euler problem 49 TBW"]
Print["Euler problem 50 TBW"]

Print["Euler problem 67"]

(* Using dynamic programming *)
euler67[] := Block[{t},t = FromDigits[#] & /@ StringSplit[#] & /@ 
                 StringSplit[
