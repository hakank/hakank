...
display(chains)
show_var_dist_pct(chains,:coinA)
show_var_dist_pct(chains,:sideA)
show_var_dist_pct(chains,:coinB)
show_var_dist_pct(chains,:sideB)

show_var_dist_pct(chains,:coinSameIsFake)
show_var_dist_pct(chains,:coinBothIsFake)
