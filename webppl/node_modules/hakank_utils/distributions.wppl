...
*/
// helper function
var negative_binomial2_tmp = function(n, p, s, f) {
    if (s == n) {
        return f
    } else {
        return flip(p) ? negative_binomial2_tmp(n,p,s+1,f) :  negative_binomial2_tmp(n,p,s,f+1)
    }
}

// n: number of failures
// p: probability of success
var negative_binomial_dist2 = function(n,p) {
    return negative_binomial2_tmp(n, p, 0, 0)
}
